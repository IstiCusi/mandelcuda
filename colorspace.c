...
static const double X[ARRAY_SIZE] = { 
...
static const double Y[ARRAY_SIZE] = {
...
static const double Z[ARRAY_SIZE] = {
...
static const double MATRIX_SRGB_D65[] = {
  3.2404542, -1.5371385, -0.4985314,
  -0.9692660,  1.8760108,  0.0415560,
  0.0556434, -0.2040259,  1.0572252
};

static double interpolate(const double values[], int index, const double offset) {
  if(offset == 0)
    return values[index];
...
void calcRGB(double len, unsigned char* rgb) {
  ...
  rgb[0] = (unsigned char)(255 * r);
  rgb[1] = (unsigned char)(255 * g);
  rgb[2] = (unsigned char)(255 * b);
}
